...
server.tool("sendWeChatTextMessage", "发送企业微信文本消息", {
...
server.resource("api", "file:///api.md", async (uri) => {
    try {
        console.info(uri);
...
server.prompt("parameter_check", "参数检查", {
...
server.prompt("generateHumorousReply", "根据群聊对话生成幽默回复", {
